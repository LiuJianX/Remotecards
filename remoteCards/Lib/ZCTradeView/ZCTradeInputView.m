...
- (void)layoutSubviews
{
    ...
    self.cancleBtn.titleLabel.font = HYQIHEISIZE(ZCScreenWidth * 0.053125);
    ...
    self.okBtn.titleLabel.font = HYQIHEISIZE(ZCScreenWidth * 0.053125);
}
...
- (void)drawRect:(CGRect)rect
{
    ...
    // 画字
    NSString *title = @"请输入验证码";
    
    CGSize size = [title sizeWithFont:HYQIHEISIZE(ZCScreenWidth * 0.053125) andMaxSize:CGSizeMake(MAXFLOAT, MAXFLOAT)];
    ...
    attr[NSFontAttributeName] = HYQIHEISIZE(ZCScreenWidth * 0.053125);
